...
import com.thelastflames.skyisles.chunk_generators.SkyIslesChunkGenerator3;
...
public class SkyChunkGenerators {
    ...
    public static final RegistryObject<Codec<? extends ChunkGenerator>> SKY_ISLES = GENERATORS.register("skyisles", () -> SkyIslesChunkGenerator3.CODEC);
}
