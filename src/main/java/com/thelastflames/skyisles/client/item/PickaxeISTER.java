...
//		models.keys.clear();
		if (!models.containsKey(itemStackIn.getOrCreateTag())) {
			SkyIsles.createBFPSGraphSection("skyisles:Create Pickaxe Model", 0.25, 0.75, 0);
		...
		SkyIsles.createBFPSGraphSection("skyisles:Render Multi Material Pickaxe", 0.75, 0.25, 0);
