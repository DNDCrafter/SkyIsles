...
public class NBTUtil {
    public static CompoundTag createNBT(NBTObjectHolder<?>... objects) {
        ...
        for (NBTObjectHolder<?> object : objects) {
            if (object.getObject() instanceof String) {
            ...
            } else if (object.getObject() instanceof Tag) {
                nbt.put(object.key, (Tag) object.object);
                ...
                nbt.putUUID(object.key, (UUID) object.object);
            }
        }
        return nbt;
    }
