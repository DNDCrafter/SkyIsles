...
//	public static ItemStack swapForTool(ItemStack stack) {
...
//			newStack = new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation(stack.getItem().getRegistryName().toString().replace("ingot", "pickaxe"))));
//		} else if (ForgeRegistries.ITEMS.containsKey(new ResourceLocation(stack.getItem().getRegistryName().toString().replace("ingot", "pick")))) {
//			newStack = new ItemStack(ForgeRegistries.ITEMS.getValue(new ResourceLocation(stack.getItem().getRegistryName().toString().replace("ingot", "pick"))));
//		}
//		return newStack;
//	}
//}
